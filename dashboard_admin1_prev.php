...
#welcomeuser{
  ...
  <div class="row">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/hms/dashboard_admin1_prev.php" class="nav-link text-white active" aria-current="page">
...
<div class="container-xl">
  <h5 id="welcomeuser"><strong>Your Previous Appointments</strong>
  </h5>
</div>
<!-- </section> -->
<!-- </div> -->
<table class="table table-striped table-success" id="myTable">
  <thead>
    ...
    <th scope="col">Sr.no</th>
      ...
      <th scope="col">Reason of illness</th>
