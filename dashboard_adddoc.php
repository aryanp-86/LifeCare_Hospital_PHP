...
#welcomeuser{
  ...
  <div class="row">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/hms/dashboard_adddoc.php" class="nav-link text-white active" aria-current="page">
         Add doctor
        </a>
      </li>
      <li>
        <a href="/hms/dashboard_addpatient.php" class="nav-link text-white" >
...
if(isset($_POST['new1'])){
    $dname1=$_POST['dname1'];
    $spec1=$_POST['spec1'];
    $opdtime2=$_POST['opdtime2'];

    $sql ="INSERT INTO `doctordata` ( `dname`, `spec`, `opdtime`) VALUES ( '$dname1', '$spec1', '$opdtime2')";
$result = mysqli_query($conn,$sql);
}
if(isset($_POST['new1'])){
    $usern1=$_POST['usern1'];
    ...
    $sql ="INSERT INTO `doclogin` ( `username`, `password`,`dt`) VALUES ( '$usern1', '$pass1', current_timestamp())";
$result = mysqli_query($conn,$sql);
echo'<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Success!</strong> Doctor added succesfully!!
...
<div class="container-xl">
  <h5 id="welcomeuser"><strong>Add A Doctor</strong>
  </h5>
</div>
<form action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Doctor's Name</label>
    <input type="text" class="form-control" id="dname1" name="dname1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Speciality</label>
    <input type="text" class="form-control" id="speciality1" name="spec1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Opd Time</label>
    <input type="text" class="form-control" id="opdtime1" name="opdtime2">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Username</label>
    <input type="text" class="form-control" id="usern1" name="usern1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Password</label>
    <input type="password" class="form-control" id="pass1" name="pass1">
  </div>
  <button type="submit" class="btn btn-primary" name="new1">Submit</button>
</form>
<!-- </section> -->
<!-- </div> -->
</div>
